...
int main(int argc, char **argv) {
    ...
    actuators.push_back(new Actuator( 1, 362,   40.0, 1.00,  0.00, SAMPLING_FREQUENCY, clockwise));
    actuators.push_back(new Actuator( 2, 362,  -40.0, 1.00, -M_PI / 2.0f, SAMPLING_FREQUENCY, counterclockwise));

    actuators.push_back(new Actuator( 5, 662,  -40.0, 1.00,  0.00, SAMPLING_FREQUENCY, counterclockwise));
    actuators.push_back(new Actuator( 6, 662,   40.0, 1.00, -M_PI / 2.0f, SAMPLING_FREQUENCY, clockwise));

    actuators.push_back(new Actuator( 9, 362,   40.0, 1.00,  0.00, SAMPLING_FREQUENCY, clockwise));
    actuators.push_back(new Actuator(10, 362,  -40.0, 1.00,  M_PI / 2.0f, SAMPLING_FREQUENCY, counterclockwise));

    actuators.push_back(new Actuator(13, 662,  -40.0, 1.00,  0.00, SAMPLING_FREQUENCY, counterclockwise));
    actuators.push_back(new Actuator(14, 662,   40.0, 1.00,  M_PI / 2.0f, SAMPLING_FREQUENCY, clockwise));
