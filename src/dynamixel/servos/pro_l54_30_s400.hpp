#ifndef DYNAMIXEL_SERVOS_PRO_L54_30_S400_HPP_
#define DYNAMIXEL_SERVOS_PRO_L54_30_S400_HPP_
    ...
    namespace servos {
        ...
        struct ModelTraits<ProL5430S400> {
            ...
            struct CT {
                ...
                typedef uint32_t present_speed_t; // FIXME: this should be a signed int
        ...
        class ProL5430S400 : public Servo<ProL5430S400> {
        public:
            typedef ProL5430S400 Model;

            ProL5430S400(typename protocol_t::id_t id) : Servo<ProL5430S400>(id){};

            MODEL_NAME(ProL5430S400);
