#ifndef DYNAMIXEL_SERVOS_XH430V350_HPP_
#define DYNAMIXEL_SERVOS_XH430V350_HPP_
...
namespace dynamixel {
    namespace servos {
        ...
        class Xh430V350 : public Servo<Xh430V350> {
        public:
            typedef Xh430V350 Model;

            Xh430V350(typename protocol_t::id_t id) : Servo<Xh430V350>(id){};

            MODEL_NAME(Xh430V350);
