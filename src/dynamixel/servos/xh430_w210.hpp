#ifndef DYNAMIXEL_SERVOS_XH430W210_HPP_
#define DYNAMIXEL_SERVOS_XH430W210_HPP_
...
namespace dynamixel {
    namespace servos {
        ...
        class Xh430W210 : public Servo<Xh430W210> {
        public:
            typedef Xh430W210 Model;

            Xh430W210(typename protocol_t::id_t id) : Servo<Xh430W210>(id){};

            MODEL_NAME(Xh430W210);
