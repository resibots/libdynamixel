#ifndef DYNAMIXEL_SERVOS_PRO_H54_200_S500_HPP_
#define DYNAMIXEL_SERVOS_PRO_H54_200_S500_HPP_
    ...
    namespace servos {
        ...
        struct ModelTraits<ProH54200S500> {
            ...
            struct CT {
                ...
                static constexpr double rpm_per_tick = 1 / 500.;
        ...
        class ProH54200S500 : public Servo<ProH54200S500> {
        public:
            typedef ProH54200S500 Model;

            ProH54200S500(typename protocol_t::id_t id) : Servo<ProH54200S500>(id){};

            MODEL_NAME(ProH54200S500);
