#ifndef DYNAMIXEL_SERVOS_PRO_M42_10_S260_HPP_
#define DYNAMIXEL_SERVOS_PRO_M42_10_S260_HPP_
    ...
    namespace servos {
        ...
        struct ModelTraits<ProM4210S260> {
            ...
            struct CT {
                ...
                static const goal_position_t min_goal_position = -131584;
                static const goal_position_t max_goal_position = 131584;
                ...
                static constexpr double rpm_per_tick = 1 / 260.;
        ...
        class ProM4210S260 : public Servo<ProM4210S260> {
        public:
            typedef ProM4210S260 Model;

            ProM4210S260(typename protocol_t::id_t id) : Servo<ProM4210S260>(id){};

            MODEL_NAME(ProM4210S260);
