#ifndef DYNAMIXEL_SERVOS_MX_64_P2_HPP_
#define DYNAMIXEL_SERVOS_MX_64_P2_HPP_
...
namespace dynamixel {
    namespace servos {
        ...
        public:
            ...
            Mx64P2(typename protocol_t::id_t id) : Servo<Mx64P2>(id){};
