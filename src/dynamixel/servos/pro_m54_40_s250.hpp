#ifndef DYNAMIXEL_SERVOS_PRO_m54_40_S250_HPP_
#define DYNAMIXEL_SERVOS_PRO_m54_40_S250_HPP_
    ...
    namespace servos {
        ...
        struct ModelTraits<ProM5440S250> {
            ...
            struct CT {
                ...
                static const goal_position_t min_goal_position = -125700;
                static const goal_position_t max_goal_position = 125700;
                ...
                static constexpr double rpm_per_tick = 1 / 250.;
        ...
        class ProM5440S250 : public Servo<ProM5440S250> {
        public:
            typedef ProM5440S250 Model;

            ProM5440S250(typename protocol_t::id_t id) : Servo<ProM5440S250>(id){};

            MODEL_NAME(ProM5440S250);
