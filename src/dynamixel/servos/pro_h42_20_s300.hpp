#ifndef DYNAMIXEL_SERVOS_PRO_H42_20_S300_HPP_
#define DYNAMIXEL_SERVOS_PRO_H42_20_S300_HPP_
    ...
    namespace servos {
        ...
        struct ModelTraits<ProH4220S300> {
            ...
            struct CT {
                ...
                static const goal_position_t min_goal_position = -151900;
                static const goal_position_t max_goal_position = 151900;
        ...
        class ProH4220S300 : public Servo<ProH4220S300> {
        public:
            typedef ProH4220S300 Model;

            ProH4220S300(typename protocol_t::id_t id) : Servo<ProH4220S300>(id){};

            MODEL_NAME(ProH4220S300);
