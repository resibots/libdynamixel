#ifndef DYNAMIXEL_SERVOS_MX_106_P2_HPP_
#define DYNAMIXEL_SERVOS_MX_106_P2_HPP_
...
namespace dynamixel {
    namespace servos {
        ...
        class Mx106P2 : public Servo<Mx106P2> {
        public:
            typedef Mx106P2 Model;

            Mx106P2(typename protocol_t::id_t id) : Servo<Mx106P2>(id){};
