#ifndef DYNAMIXEL_SERVOS_XM430W210_HPP_
#define DYNAMIXEL_SERVOS_XM430W210_HPP_
...
namespace dynamixel {
    namespace servos {
        ...
        class Xm430W210 : public Servo<Xm430W210> {
        public:
            typedef Xm430W210 Model;

            Xm430W210(typename protocol_t::id_t id) : Servo<Xm430W210>(id){};

            MODEL_NAME(Xm430W210);
