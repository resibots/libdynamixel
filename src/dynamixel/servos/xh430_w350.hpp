#ifndef DYNAMIXEL_SERVOS_XH430W350_HPP_
#define DYNAMIXEL_SERVOS_XH430W350_HPP_
...
namespace dynamixel {
    namespace servos {
        ...
        class Xh430W350 : public Servo<Xh430W350> {
        public:
            typedef Xh430W350 Model;

            Xh430W350(typename protocol_t::id_t id) : Servo<Xh430W350>(id){};

            MODEL_NAME(Xh430W350);
