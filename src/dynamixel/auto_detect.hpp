...
namespace dynamixel {
inline std::shared_ptr<servos::BaseServo<protocols::Protocol1>>
get_servo(protocols::Protocol1::address_t id, uint16_t model) {
  switch (model) {
...
inline std::shared_ptr<servos::BaseServo<protocols::Protocol2>>
get_servo(protocols::Protocol2::address_t id, uint16_t model) {
  switch (model) {
